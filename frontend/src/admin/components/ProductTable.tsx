// frontend/src/admin/components/ProductTable.tsx
...
export default function ProductTable() {
    ...
    const handleView = (id: number) => window.open(`/producto/${id}`, "_blank");
    const handleEdit = (id: number) => navigate(`/admin/products/edit/${id}`);
