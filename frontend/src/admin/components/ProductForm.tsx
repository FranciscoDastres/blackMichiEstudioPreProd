// frontend/src/admin/components/ProductForm.tsx
...
export default function ProductForm({ initialData, onSubmit }: ProductFormProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            fd.append("nombre", String(formData.nombre));
            fd.append("titulo", String(formData.nombre));
            ...
            fd.append("descripcion", String(formData.descripcion));
