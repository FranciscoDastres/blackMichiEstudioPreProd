...
export default function Settings() {
    ...
    const [formData, setFormData] = useState({
        section1: { title: "", subtitle: "", buttonText: "", categoria: "" },
        section2: { title: "", subtitle: "", buttonText: "", categoria: "" },
        section3: { title: "", subtitle: "", buttonText: "", categoria: "" },
        section4: { title: "", subtitle: "", buttonText: "", categoria: "" },
        section5: { title: "", subtitle: "", buttonText: "", categoria: "" },
        section6: { title: "", subtitle: "", buttonText: "", categoria: "" }
    });
        ...
        try {
            ...
            sections.forEach(key => {
                if (data[key]) {
                    ...
                    // Si no existe data, inicializar vacío
    ...
    const handleFileChange = (section, file) => {
        if (file) {
            ...
            reader.onloadend = () => {
                setPreviews(prev => ({ ...prev, [section]: reader.result }));
            };
    ...
    const handleUpload = async (section) => {
        ...
        try {
            ...
            const { data } = await api.post("/admin/hero-images", formDataToSend, {
            ...
            setMessage({
                type: "error",
                text: "❌ Error al actualizar. Verifica los datos e inténtalo nuevamente."
            });
        } finally {
            setLoading(false);
