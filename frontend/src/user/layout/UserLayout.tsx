...
import { User, ShoppingBag, Shield, LogOut, Store, MessageSquare, Heart, LucideIcon } from "lucide-react";
                ...
                <div className="flex items-center justify-between px-4 py-2.5 border-b border-border/50">
                    <div className="flex items-center gap-2.5">
                        ...
                        <span className="text-sm font-medium text-foreground truncate max-w-[160px]">
                            {(user as { nombre?: string } | null)?.nombre || "Usuario"}
                        </span>
                    </div>
            ...
            <div className="relative z-10 max-w-6xl mx-auto px-4 py-6 lg:py-10 lg:flex lg:gap-8">
                ...
                <aside className="hidden lg:block w-64 shrink-0">
                    ...
                    <div className="glass-panel border border-border rounded-2xl p-6 mb-4 text-center">
                        ...
                        <p className="text-xs text-muted truncate mt-0.5">{(user as { email?: string } | null)?.email}</p>
