...
function SuccessRouteWrapper() {
  ...
  const locationState = state as { message?: string; actionText?: string; actionTo?: string } | null;
  return (
    <Layout>
      <Suspense fallback={<PageLoadingFallback />}>
        <Success
          message={locationState?.message || "¡Acción exitosa!"}
          actionText={locationState?.actionText}
          actionTo={locationState?.actionTo}
        />
      </Suspense>
    </Layout>
  );
