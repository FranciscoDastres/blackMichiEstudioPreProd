    ...
    useEffect(() => {
        const fetchHeroImages = async () => {
            try {
                ...
                setSlides([
                    { id: "1", title: "Black Michi Studio", subtitle: "Diseños exclusivos para gamers", image_url: "https://images.unsplash.com/photo-1550745165-9bc0b252726f?w=800&auto=format&fit=crop", button_text: "Explorar Colección" },
                    { id: "2", title: "Soportes Personalizados", subtitle: "Arte y funcionalidad en cada diseño", image_url: "https://images.unsplash.com/photo-1593305841991-05c297ba4575?w=800&auto=format&fit=crop", button_text: "Ver Soportes" },
                    { id: "3", title: "Figuras Únicas", subtitle: "Elaboradas completamente a mano", image_url: "https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=800&auto=format&fit=crop", button_text: "Ver Figuras" }
                ]);
            } finally {
                setLoading(false);
            }
                    ...
                    {slides.map(({ id, title, subtitle, image_url, button_text = "Explorar Colección" }, index) => (
                        <SwiperSlide key={id}>
                            <div className="relative h-[300px] sm:h-[380px] md:h-[460px] xl:h-[560px] overflow-hidden">
                                ...
                                {/* Imagen de fondo — cubre todo el section */}
                                <img
                                    src={getImageUrl(image_url, 1400, null, 80)}
                                    alt=""
                                    aria-hidden="true"
                                ...
                                {/* Overlay: oscurece el fondo para que el texto sea legible */}
                                <div className="absolute inset-0 z-10 bg-gradient-to-r from-background/90 via-background/55 to-transparent" />
