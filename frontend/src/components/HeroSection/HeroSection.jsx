                        ...
                        <SwiperSlide key={id}>
                            <div className="relative h-[300px] sm:h-[380px] md:h-[460px] xl:h-[560px] overflow-hidden">
                                ...
                                <img
                                    ...
                                    srcSet={`${getImageUrl(image_url, 345, 230, 85)} 345w, ${getImageUrl(image_url, 702, 460, 85)} 702w, ${getImageUrl(image_url, 1024, 670, 85)} 1024w`}
                                        ...
                                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
                                            ...
                                            <div className="relative hidden lg:block">
                                                <div className="relative">
                                                    ...
                                                    <img
                                                        src={getImageUrl(image_url, 600, 375, 85)}
                                                        alt={title}
                                                        width="800"
                                                        height="500"
                                                        fetchPriority={index === 0 ? "high" : "auto"}
                                                        loading={index === 0 ? "eager" : "lazy"}
                                                        srcSet={`${getImageUrl(image_url, 400, 250, 85)} 400w, ${getImageUrl(image_url, 600, 375, 85)} 600w, ${getImageUrl(image_url, 800, 500, 85)} 800w`}
