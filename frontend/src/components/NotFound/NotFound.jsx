  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background px-4 py-12 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-2xl w-full text-center">
        {/* 404 huge */}
        <h1 className="text-[8rem] md:text-[12rem] font-black leading-none bg-gradient-to-b from-primary via-primary/70 to-transparent bg-clip-text text-transparent select-none">
          404
        </h1>
