...
export async function getAllOrders(): Promise<unknown[]> {
    const result = await db.query(`
...
export async function updateOrderStatus(
    id: number | string,
    estado: string,
    numero_seguimiento: string | null = null
...
export async function updateUserRole(id: number | string, rol: string): Promise<unknown> {
