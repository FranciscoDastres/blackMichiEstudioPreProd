// backend/services/favoritosService.js
...
export async function listarIds(usuarioId) {
    const result = await db.query(
...
export async function quitar(usuarioId, productoId) {
    const result = await db.query(
...
export async function toggle(usuarioId, productoId) {
